...
_Note, if you are new to react, then read the [react documentation](https://reactjs.org/docs) first and make sure that you have installed all required dev-dependencies like babel._
...
Now you can render it onto the page with the `ReactDOM.render`-method like this:
...
Now you should see a paragraph with the text `A line of text in a paragraph.`. And when you type, you should see the text change!
